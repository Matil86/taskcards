...
class CardsScreenBasicTest {
    ...
    @Test
    fun rendersDeckStackWithTasksAndCompletionMessageWhenEmpty() = runTest(dispatcher) {
    ...
    @Test
    fun displaysCompletionCelebrationWhenAllTasksAreDone() = runTest(dispatcher) {
        val repo = InMemoryTaskListRepository(dispatcher)
