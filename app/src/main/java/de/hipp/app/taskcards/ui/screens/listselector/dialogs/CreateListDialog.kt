...
fun CreateListDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(
                text = stringResource(R.string.list_selector_create_dialog_title),
        ...
        confirmButton = {
            TextButton(
                ...
                enabled = listName.trim().isNotEmpty()
            ) {
                Text(stringResource(R.string.list_selector_create_button))
            }
        },
        dismissButton = {
